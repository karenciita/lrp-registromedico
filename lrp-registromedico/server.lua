...
-- Fetch
ESX.RegisterServerCallback('lrp-registromedico:fetch', function( source, cb, data, type )
  if type == 'start' then
...
-- Search
ESX.RegisterServerCallback('lrp-registromedico:search', function( source, cb, data )
...
-- Add
ESX.RegisterServerCallback('lrp-registromedico:add', function( source, cb, data )
...
-- Update
ESX.RegisterServerCallback('lrp-registromedico:update', function( source, cb, data )
...
-- Remove
ESX.RegisterServerCallback('lrp-registromedico:remove', function( source, cb, data )
